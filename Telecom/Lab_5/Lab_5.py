...
if __name__ == '__main__':
    ...
    carrier_freq = 50
    carrier_amplitude = 1
    phase_modulated = carrier_amplitude * np.sin(2 * np.pi * carrier_freq * t + sig_ampl * sig)
    ...
    plt.legend(('PM modulated sine wave', 'PM demodulated sine wave'), loc='upper right')
    plt.show()
    ...
    plt.legend(('PM modulated sine wave', 'PM demodulated sine wave'), loc='upper right')  # TODO fix legends
    plt.show()
